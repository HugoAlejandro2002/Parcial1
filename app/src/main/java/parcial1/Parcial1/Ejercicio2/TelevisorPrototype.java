...
public class TelevisorPrototype implements ITelevisor{
    private String so;
    ...
    public void showInfo(){
        System.out.println();
        System.out.println("Sistema Operativo: " + this.getSo());
    ...
    public TelevisorPrototype clone() {
        TelevisorPrototype televisorPrototypeClone = new TelevisorPrototype();
